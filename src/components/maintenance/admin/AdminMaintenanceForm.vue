...
function validateForm() {
    ...
    if (!form.machineId.trim()) {
        ...
        const parsedMachineId = parseInt(form.machineId);
    ...
    // 驗證保養描述
    if (!form.maintenanceDescription.trim()) {
        errors.maintenanceDescription = '請輸入保養描述';
        isValid = false;
    } else if (form.maintenanceDescription.length > 500) {
    ...
    if (!form.employeeId.trim()) {
        ...
        const parsedEmployeeId = parseInt(form.employeeId);
...
function handleCancel() {
    // 這裡可以導向列表頁面或其他頁面
    window.location.href = '/AdminMaintenanceServlet';
}
    ...
    <div class="maintenance-form">
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                <label for="machineId">
                    <i class="fas fa-microchip"></i> 機台編號：
                </label>
                <input 
                    id="machineId"
            ...
            <div class="form-group">
                <label for="maintenanceDescription">
                    <i class="fas fa-align-left"></i> 保養描述：
                </label>
                <textarea 
            ...
            <div class="form-group">
                <label for="employeeId">
                    <i class="fas fa-user-tie"></i> 員工編號：
                </label>
                <input 
                    id="employeeId"
...
<style scoped>
/* 引入 Font Awesome 和 Google Fonts */
